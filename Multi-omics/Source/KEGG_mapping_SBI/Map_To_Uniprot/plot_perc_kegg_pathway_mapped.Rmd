...
metabolism_perc_nodes_found_matrix_sorted <- metabolism_perc_nodes_found_matrix %>% 
  ...
  mutate( average_percentage = rowSums( dplyr::select(., -contains("KEGG"))    )/
                               length( vars_select(colnames(.), -contains( "KEGG")) ) ) %>%
  arrange(desc(average_percentage))
  
write_tsv( metabolism_perc_nodes_found_matrix_sorted, 
...
write_tsv( non_metabolism_perc_nodes_found_matrix_sorted, 
